...
UNITREE_ROS_DIR = (
    "/home/kist/work/workspace/unitree_rl_lab/unitree_ros"  # Replace with the actual path to your unitree_ros package
)
...
UNITREE_G1_29DOF_CFG = UnitreeArticulationCfg(
    ...
    #     usd_path=f"/home/kist/work/workspace/g1_29dof_woa.usd",
    # ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.8),
        joint_pos={
